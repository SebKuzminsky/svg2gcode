...
*finishing* (object, optional):: A *finishing* object machines the pocket
slightly undersize (ie with a little extra material left "on the walls").
The properties of the *finishing* object are:
