...
*work-holding-tabs-height* (float, optional):: Height of work holding
tabs, in mm.  Defaults to 0.5mm if omitted.

*work-holding-tabs-width* (float, optional):: Width of work holding tabs,
in mm.  No cutter diameter compensation is performed when "stepping over"
the tabs, so this value should be greater than one cutter diameter or
the tabs will be cut away.  Defaults to 10mm if omitted.
